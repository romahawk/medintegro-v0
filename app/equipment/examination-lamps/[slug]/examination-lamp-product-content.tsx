...
const copy = {
  en: {
    equipment: "Equipment",
    category: "Examination Lamps",
    back: "Back to Examination Lamps",
    quote: "Request Quote",
    overviewHeading: "Overview",
    highlightsHeading: "Key Highlights",
    capabilitiesHeading: "Core capabilities for specialist care environments",
  },
  ua: {
    equipment: "Обладнання",
    category: "Оглядові світильники",
    back: "Назад до оглядових світильників",
    quote: "Отримати пропозицію",
    overviewHeading: "Огляд",
    highlightsHeading: "Ключові переваги",
    capabilitiesHeading: "Ключові можливості для спеціалізованих клінічних середовищ",
  },
} as const
...
export function ExaminationLampProductContent({ product }: Props) {
  const { locale } = useLanguage()
  const t = copy[locale]
  const localizedProduct = getLocalizedExaminationLampProduct(product, locale)
